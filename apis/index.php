<?php
    ...
    include_once __DIR__.'/models/RevenueAndSavingsControl.php';
    include_once __DIR__.'/models/Revenue.php';
    include_once __DIR__.'/models/Statement.php';
    ...
    switch($request) {
        ...
        case str_contains($_SERVER['REQUEST_URI'], $prefixApi.'/list-revenues'):
            //VERIFICA O MÉTODO ENVIADO NA REQUEST
            switch($_SERVER['REQUEST_METHOD']) {
                case 'GET':
                    $data = explode('/', $_SERVER['REQUEST_URI']);
                    ...
                    if($userId != 'users' && 
                        ...
                        $monthYear != '') {
                            ...
                            if($authorizationHeaderInformed) {
                                ...
                                if($obAccessToken->isTokenValid()) {
                                    //BUSCA OS DADOS
                                    require __DIR__ .'/api/v1/revenue/read_by_period.php';
                                } else {
                                    http_response_code(401);
                                    echo json_encode('Invalid token');    
                                }
                        ...
                        $monthYear != 'create') {
                            ...
                            if($authorizationHeaderInformed) {
                                ...
                                if($obAccessToken->isTokenValid()) {
                                    ...
                                    require __DIR__.'/api/v1/budget/create.php';
                                } else {
                                    http_response_code(401);
                                    echo json_encode('Invalid token');    
                                }
        ...
        case str_contains($_SERVER['REQUEST_URI'], $prefixApi.'/transfer-budget/users'):
            //VERIFICA O MÉTODO ENVIADO NA REQUEST
            switch($_SERVER['REQUEST_METHOD']) {
                case 'POST':
                    $data = explode('/', $_SERVER['REQUEST_URI']);
                    ...
                    if($userId != 'users' && 
                        ...
                        $familyId != '') {
                            ...
                            if($authorizationHeaderInformed) {
                                ...
                                if($obAccessToken->isTokenValid()) {
                                    // ATUALIZA OS DADOS
                                    require __DIR__.'/api/v1/budget/transfer_budget.php';
                                } else {
                                    http_response_code(401);
                                    echo json_encode('Invalid token');    
                                }
        ...
        case str_contains($_SERVER['REQUEST_URI'], $prefixApi.'/increase-budget/users'):
            //VERIFICA O MÉTODO ENVIADO NA REQUEST
            switch($_SERVER['REQUEST_METHOD']) {
                case 'PATCH':
                    $data = explode('/', $_SERVER['REQUEST_URI']);
                    ...
                    if($userId != 'users' && 
                        ...
                        $monthYear != '') {
                            ...
                            if($authorizationHeaderInformed) {
                                ...
                                if($obAccessToken->isTokenValid()) {
                                    //Aumentar orçamento
                                    require __DIR__.'/api/v1/budget/increase_budget.php';
                                } else {
                                    http_response_code(401);
                                    echo json_encode('Invalid token');    
                                }
        ...
        case str_contains($_SERVER['REQUEST_URI'], $prefixApi.'/savings/users'):
            //VERIFICA O MÉTODO ENVIADO NA REQUEST
            switch($_SERVER['REQUEST_METHOD']) {
                case 'POST':
                    $data = explode('/', $_SERVER['REQUEST_URI']);
                    ...
                    if($userId != 'users' && 
                        ...
                        $monthYear != 'create') {
                            ...
                            if($authorizationHeaderInformed) {
                                ...
                                $obAccessToken->Session_Access_Token = $accessToken;
                                if($obAccessToken->isTokenValid()) {
                                    //CADASTRA O REGISTRO DE ECONOMIA
                                    require __DIR__ .'/api/v1/savings/create.php';
                                } else {
                                    http_response_code(401);
                                    echo json_encode('Invalid token');    
                                }
        ...
        case str_contains($_SERVER['REQUEST_URI'], $prefixApi.'/list-budgets-already-set-on-period/users'):
            //VERIFICA O MÉTODO ENVIADO NA REQUEST
            switch($_SERVER['REQUEST_METHOD']) {
                case 'GET':
                    $data = explode('/', $_SERVER['REQUEST_URI']);
                        ...
                        $monthYear != '') {
                            ...
                            if($authorizationHeaderInformed) {
                                ...
                                if($obAccessToken->isTokenValid()) {
                                    ...
                                    require __DIR__ .'/api/v1/budget/read_budgets_already_set.php';
                                } else {
                                    http_response_code(401);
                                    echo json_encode('Invalid token');    
                                }
        ...
        case str_contains($_SERVER['REQUEST_URI'], $prefixApi.'/get-all-budgets/users'):
            //VERIFICA O MÉTODO ENVIADO NA REQUEST
            switch($_SERVER['REQUEST_METHOD']) {
                case 'GET':
                    $data = explode('/', $_SERVER['REQUEST_URI']);
                    ...
                    if($userId != 'users' && 
                        ...
                        $familyId != '') {
                            ...
                            if($authorizationHeaderInformed) {
                                ...
                                if($obAccessToken->isTokenValid()) {
                                    //CONSULTA OS ORÇAMENTOS
                                    require __DIR__ .'/api/v1/budget/read_all_budgets.php';
                                } else {
                                    http_response_code(401);
                                    echo json_encode('Invalid token');    
                                }
        ...
        case str_contains($_SERVER['REQUEST_URI'], $prefixApi.'/set-new-budget-value/users'):
            //VERIFICA O MÉTODO ENVIADO NA REQUEST
            switch($_SERVER['REQUEST_METHOD']) {
                case 'PATCH':
                    $data = explode('/', $_SERVER['REQUEST_URI']);
                    ...
                    if($userId != 'users' && 
                        ...
                        $familyId != '') {
                            ...
                            if($authorizationHeaderInformed) {
                                ...
                                if($obAccessToken->isTokenValid()) {
                                    //CONSULTA OS ORÇAMENTOS
                                    require __DIR__ .'/api/v1/budget/set_new_budget_value.php';
                                } else {
                                    http_response_code(401);
                                    echo json_encode('Invalid token');    
                                }
        ...
        case str_contains($_SERVER['REQUEST_URI'], $prefixApi.'/list-budgets/users'):
            //VERIFICA O MÉTODO ENVIADO NA REQUEST
            switch($_SERVER['REQUEST_METHOD']) {
                case 'GET':
                    $data = explode('/', $_SERVER['REQUEST_URI']);
                    ...
                    if($userId != 'users' && 
                        ...
                        $monthYear != '') {
                            ...
                            if($authorizationHeaderInformed) {
                                ...
                                if($obAccessToken->isTokenValid()) {
                                    //CONSULTA OS ORÇAMENTOS
                                    require __DIR__ .'/api/v1/budget/read_budgets.php';
                                } else {
                                    http_response_code(401);
                                    echo json_encode('Invalid token');    
                                }
                    ...
                    if($userId != 'users' && 
                        ...
                        $monthYear != '') {
                            ...
                            if($authorizationHeaderInformed) {
                                ...
                                $obAccessToken->Session_Access_Token = $accessToken;
                                if($obAccessToken->isTokenValid()) {
                                    //CONSULTA OS DADOS DO EXTRATO
                                    require __DIR__ .'/api/v1/statement/read.php';
                                } else {
                                    http_response_code(401);
                                    echo json_encode('Invalid token');    
                                }
        ...
        case str_contains($_SERVER['REQUEST_URI'], $prefixApi.'/statement-details/users'):
            //VERIFICA O MÉTODO ENVIADO NA REQUEST
            switch($_SERVER['REQUEST_METHOD']) {
                case 'GET':
                    $data = explode('/', $_SERVER['REQUEST_URI']);
                    $userId = $data[count($data) - 7];
                    ...
                    if($userId != 'users' && 
                        ...
                        $budgetId != 'budgets') {
                            ...
                            if($authorizationHeaderInformed) {
                                ...
                                if($obAccessToken->isTokenValid()) {
                                    //CONSULTA OS DADOS DO EXTRATO
                                    require __DIR__ .'/api/v1/statement/read_details.php';
                                } else {
                                    http_response_code(401);
                                    echo json_encode('Invalid token');    
                                }
                            ...
                            http_response_code(401);
                            echo json_encode('userId, familyId, period and budgetId are required');
                        }
                    break;
                default:
                    http_response_code(403);
        ...
        case str_contains($_SERVER['REQUEST_URI'], $prefixApi.'/expenses-categories/users'):
            //VERIFICA O MÉTODO ENVIADO NA REQUEST
            switch($_SERVER['REQUEST_METHOD']) {
                case 'GET':
                    $data = explode('/', $_SERVER['REQUEST_URI']);
                        ...
                        $userId != '') {
                            ...
                            if($authorizationHeaderInformed) {
                                ...
                                if($obAccessToken->isTokenValid()) {
                                    ...
                                    require __DIR__ .'/api/v1/expense/read_categories.php';
                                } else {
                                    http_response_code(401);
                                    echo json_encode('Invalid token');    
                                }
        ...
        case str_contains($_SERVER['REQUEST_URI'], $prefixApi.'/expenses/users/') && str_contains($_SERVER['REQUEST_URI'], '/current-month'):
            //VERIFICA O MÉTODO ENVIADO NA REQUEST
            switch($_SERVER['REQUEST_METHOD']) {
                case 'GET':
                    $data = explode('/', $_SERVER['REQUEST_URI']);
                    ...
                    if($userId != 'users' && 
                        ...
                        $userId != '' &&
                        $userId != 'families' &&
                        $userId != 'current-month' &&
                        $familyId != 'users' &&
                        $familyId != '/' &&
                        $familyId != '' &&
                        $familyId != 'families' &&
                        $familyId != 'current-month') {
                            ...
                            if($authorizationHeaderInformed) {
                                ...
                                if($obAccessToken->isTokenValid()) {
                                    ...
                                    require __DIR__ .'/api/v1/expense/read_current_month.php';
                                } else {
                                    http_response_code(401);
                                    echo json_encode('Invalid token');    
                                }
